...
#
# ************************************************
# Kona (n5110) CyanogenMod 13.0 Version by ZaneZam
#
...
KERNEL_SPECS="n5110;cm;cm13.0;http://kernel.boeffla.de/zanezam/n5110/boeffla-kernel/;boeffla-kernel-#VERSION#-CM13.0-n5110-anykernel.recovery.zip"
