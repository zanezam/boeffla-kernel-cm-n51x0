...
#
# ************************************************
# Kona (n5110) LineageOS 14.1 Version by ZaneZam
#
...
KERNEL_SPECS="n5110;cm;cm14.1;http://kernel.boeffla.de/zanezam/n5110/boeffla-kernel/;boeffla-kernel-#VERSION#-Lineage14.1-n5110-anykernel.recovery.zip"
