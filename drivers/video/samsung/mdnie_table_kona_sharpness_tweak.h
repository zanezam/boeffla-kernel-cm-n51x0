	...
	{
		{
			...
			// The second cabc mode uses the same MDNIE table again
		{
			{"dynamic_ui_cabc",		tune_dynamic_ui_sharp_tweak},
			{"dynamic_video_cabc",		tune_dynamic_video_sharp_tweak},
			{"dynamic_video_cabc",		tune_dynamic_video_sharp_tweak},
			{"dynamic_video_cabc",		tune_dynamic_video_sharp_tweak},
			{"camera",			tune_camera_sharp_tweak},
			{"dynamic_ui_cabc",		tune_dynamic_ui_sharp_tweak},
			{"dynamic_gallery_cabc",	tune_dynamic_gallery_sharp_tweak},
			{"dynamic_vt_cabc",		tune_dynamic_vt_sharp_tweak},
		}, {
			{"standard_ui_cabc",		tune_standard_ui_sharp_tweak},
			{"standard_video_cabc",		tune_standard_video_sharp_tweak},
			{"standard_video_cabc",		tune_standard_video_sharp_tweak},
			{"standard_video_cabc",		tune_standard_video_sharp_tweak},
			{"camera",			tune_camera_sharp_tweak},
			{"standard_ui_cabc",		tune_standard_ui_sharp_tweak},
			{"standard_gallery_cabc",	tune_standard_gallery_sharp_tweak},
			{"standard_vt_cabc",		tune_standard_vt_sharp_tweak},
		}, {
			{"movie_ui_cabc",		tune_movie_ui_sharp_tweak},
			{"movie_video_cabc",		tune_movie_video_sharp_tweak},
			{"movie_video_cabc",		tune_movie_video_sharp_tweak},
			{"movie_video_cabc",		tune_movie_video_sharp_tweak},
			{"camera",			tune_camera_sharp_tweak},
			{"movie_ui_cabc",		tune_movie_ui_sharp_tweak},
			{"movie_gallery_cabc",		tune_movie_gallery_sharp_tweak},
			{"movie_vt_cabc",		tune_movie_vt_sharp_tweak},
		} /*, {
			// with "old" mdnie, auto behaves like standard mode
			{"auto_ui",			tune_standard_ui_sharp_tweak},
			{"auto_video",			tune_standard_video_sharp_tweak},
